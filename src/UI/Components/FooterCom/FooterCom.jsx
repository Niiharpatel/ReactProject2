          ...
          <div className="row">
            <div className="col-4">
              ...
              <div className="text-white fs-6">
                <address>
                  Hno: 277 Near RingRoad,Surat <br />
                  Pincode: 15634
                </address>
                <a
                  href="tel:+91 8678459300"
                  className="mt-3 d-block mb-3 text-white"
                >
                  +91 8678459300
                </a>
                <a
                  href="mailto:nihar7898@gmail.com"
                  className="mt-3 d-block mb-3 text-white"
                >
                  nihar7898@gmail.com
                </a>
            ...
            <div className="col-2">
              ...
              <div className="footer-links d-flex flex-column">
                ...
                <Link className="text-white py-2 mb-1">Tablest</Link>
          ...
          <div className="row">
            <div className="col-12">
              <p className="text-center mb-0 text-white">
                &copy; {new Date().getFullYear}; Powered by Niihar
              </p>
            </div>
          </div>
        </div>
